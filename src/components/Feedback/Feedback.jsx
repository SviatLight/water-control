...
const Feedback = () => {
  ...
  const sendFeedback = () => {
    const newFeedback = {"userName": dbUser.userName, "comment": areaRef.current.value};
  ...
  return (
    <div className={style.feedback_wrapper}>
      ...
      <h1 className={style.feedback_title}>Feedbacks about water control app</h1>

      <div>
        <div className={user ? style.feedbacks : `${style.feedbacks} ${style.height_feedbacks}`}>
          {
            ...
            ? (
              <div>
                <textarea
                  ...
                  ref={areaRef}
                />
                <button className={`btn btn-primary ${style.feedback_submit}`} type='submit' onClick={sendFeedback}>
                  Send feedback
                </button>
              </div>
            ) : <></>
