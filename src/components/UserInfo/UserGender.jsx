  ...
  return (
    <div className={style.user_info_wrapper}>
      ...
      <div className={style.user_info_container}>
        <div className={currentUser.gender === 'male' ? `${style.gender} ${style.active}` : style.gender}
             onClick={() => setGender('male')}>
          <img className={style.images} src={boy}/>
          <span>Male</span>
        </div>
        <div className={currentUser.gender === 'female' ? `${style.gender} ${style.active}` : style.gender}
